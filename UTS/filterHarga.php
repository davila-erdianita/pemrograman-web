    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link active" href=filterHarga.php>filter harga</a>
        </div>
      </div>
      </div>
</nav>
...
<div class="container text-center">
<form action="filterHarga.php" method="POST">
...
if($_SERVER['REQUEST_METHOD']=== 'POST'){
  $min=$_POST['min'];
  $max=$_POST['max'];
  echo"<b>Hasil Pencarian untuk rentang harga minimal $min dan maximal $max</b>";
}
?>
</div>
  ...
  <div class="row">
    ...
    <a href="form.php">Tambah data</a>
          <h2 style="margin: 30px 0 30px 0;">barang</h2>
            <table class="table">
              <thead>
                <tr>
                  <th>No</th>
